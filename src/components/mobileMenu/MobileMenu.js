...
const MobileMenu = ({showMenu, active}) => {
  return (
    <div className=''>
        <ul className={active ? 'font-secondFont text-sm fixed right-0 top-0 h-screen w-1/2  bg-blueDark flex flex-col justify-start items-center gap-5 md:hidden' : 'hidden'}>
